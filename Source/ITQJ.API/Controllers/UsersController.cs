...
namespace ITQJ.API.Controllers
{
    ...
    public class UsersController : BaseController
    {
        ...
        public ActionResult GetCurrentlyLoggedInUser()
        {
            ...
            if (user is null)
            {
                var clientAccess = new RestClient("https://dev-nml69oj8.us.auth0.com/oauth/token");
                var requestToken = new RestRequest(Method.POST);
                requestToken.AddHeader("Content-Type", "application/x-www-form-urlencoded");
                requestToken.AddParameter("application/x-www-form-urlencoded", "grant_type=client_credentials&client_id=uQuYPNSJ0HUkeVWjQ1PyMICs9SZGHLQv&client_secret=azeYZkCUo3z3UF2UjpR1bnA41Re8eLwoA7bmPP0GmSf60d3Yal2odnSmp17xf6XQ&audience=https%3A%2F%2Fdev-nml69oj8.us.auth0.com%2Fapi%2Fv2%2F", ParameterType.RequestBody);
                ...
                var clientInfo = new RestClient($"https://dev-nml69oj8.us.auth0.com/api/v2/users/{subject}");
