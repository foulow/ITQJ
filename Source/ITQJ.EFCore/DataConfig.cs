    ...
    public class DataConfig
    {
        ...
        public static IEnumerable<Skill> Skills =>
            new Skill[]
            {
                ...
                new Skill { Name = "Perl",                                              Path = "/icon-Tecnology/Perl.jpg"},
                ...
                new Skill { Name = "Plymer",                                            Path = "/icon-Tecnology/"},
                ...
                new Skill { Name = "Xamarin",                                           Path = "/icon-Tecnology/"},
                ...
                new Skill { Name = "Edge",                                              Path = "/icon-Tecnology/"},
                ...
                new Skill { Name = "NetBens",                                           Path = "/icon-Tecnology/"},
                ...
                new Skill { Name = "Dev C++",                                           Path = "/icon-Tecnology/"},
                ...
                new Skill { Name = "IIS",                                               Path = "/icon-Tecnology/"},
                new Skill { Name = "Xampp",                                             Path = "/icon-Tecnology/"},
                new Skill { Name = "Webpack",                                           Path = "/icon-Tecnology/webpack.png"},
                new Skill { Name = "Xml",                                               Path = "/icon-Tecnology/"},
